namespace Zoonic.Javascript.Hosting
{
    using System;
    ...
    public struct JavaScriptValue
    {
        ...
        public static JavaScriptValue From(object value)
        {
            if (value is String)
            {
            ...
            {
                return JavaScriptValue.FromBoolean(Convert.ToBoolean(value));
            }
            ...
            else
            {
                ...
                JavaScriptValue requestObject = JavaScriptValue.CreateObject();
                var properties = value.GetType().GetProperties();
                foreach (var property in properties)
                {
                    var obj = property.GetValue(value);
                    if (obj == null) { continue; }
                    requestObject.SetProperty(JavaScriptPropertyId.FromString(property.Name), JavaScriptValue.From(obj), true);
                }
