...
namespace Zoonic.Messages
{
    public class MessageType
    {
        ...
        public const int SCANQRCODE = 9;
        public const int SCANLINECODE = 10;
        public const int PAY = 12;
        public const int TEXT_COMMOMD = 30;
        public const int TEXT_WEATHER = 31;

        public static Zoonic.Collection.ImmutableDictionary<string, int> Types
        {
        ...
        static MessageType()
        {
            if (Types == null)
            {
                Types = Zoonic.Collection.ImmutableDictionary<string, int>.Empty;
            }
        }
