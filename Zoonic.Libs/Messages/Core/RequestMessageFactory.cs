...
namespace Zoonic.Messages
{
    ...
    {
        public abstract IRequestMessageBase GetRequest(string  docStr, TokenModel tokenModel = null);
        public abstract IRequestMessageBase GetRequest(Stream stream, TokenModel tokenModel = null);

        private static RequestMessageFactory _Factory;
        public static RequestMessageFactory Factory
        {
            get
            {
                return _Factory;
        ...
        public static void Register(RequestMessageFactory factory)
        {
            _Factory = factory;
        }
        #region 注释
        ...
        /// </summary>
        /// <returns></returns>
        public static IRequestMessageBase GetRequestEntity(XDocument doc, TokenModel postModel = null)
        {
            ...
            try
            {
                ...
                switch (msgType)
                {
                    case RequestMsgType.Text:
                        requestMessage = new RequestMessageText(doc);
                        break;
